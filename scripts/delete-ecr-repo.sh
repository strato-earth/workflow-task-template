...
usage ()
{
  echo 'Deletes ECR Repo.'
  echo ''
  echo 'Usage : delete-ecr-repo.sh -n <repo-name> -e <environment> -p <profile> '
  echo ''
...
terraform destroy -input=false -auto-approve  -var="region=$REGION" -var="profile=$PROFILE" -var="environment=$ENVIRONMENT" -var="repo_name=$REPO_NAME"
